        ...
        workItems.forEach(item => {
            ...
            item.addEventListener('click', e => {
                ...
                const contentArr = document.querySelectorAll('#detalles-container .item');
                
                document.querySelectorAll('#detalles-container .item').forEach(item => { item.classList.add('item-hide');})
                document.querySelectorAll('#detalles-container .item')[currentIndex].classList.toggle('item-hide');
                document.querySelector('#screen').style['animation-name'] = 'fade-in';
                document.querySelector('body').style['overflow'] = 'hidden';

                setTimeout(() => {
                    document.querySelector('#detalles-container').style.display = 'block';
                }, 1000);
        ...
        closeButton.addEventListener('click', e => {
            ...
            setTimeout(() => {
                ...
                document.querySelector('#detalles-container').style.display = 'none';
            }, 1000);
        ...
        function loadGalleryItem(index){
            ...
            document.querySelectorAll('#detalles-container .item').forEach(item => { item.classList.add('item-hide');})
            document.querySelectorAll('#detalles-container .item')[index].classList.toggle('item-hide'); 
